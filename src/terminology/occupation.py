"""
Occupation terminology constants.

Ported from: Satusehat\Integration\Terminology\Occupation
Source: satusehat-integration (Laravel)

Contains SNOMED CT performer role codes for healthcare practitioners.
"""
...
class Occupation:
    """
    Static healthcare occupation/performer role codes from SNOMED CT.

    Ported from Laravel static class Occupation.
    Maps SNOMED CT concept IDs to human-readable role names.
    """

    # Maps SNOMED CT code (int) -> display name
    performer_role: dict[int, str] = {
        ...
        1254982021: "Medical surgical nurse",
        ...
        44652026: "Pharmaceutical assistant",
        46255001: "Pharmacist",

...
class ExplanationOfBenefitBuilder(BaseBuilder):
    ...
    def __init__(self):
        super().__init__("ExplanationOfBenefitBuilder")
        self.data = {"resourceType": "ExplanationOfBenefit"}
